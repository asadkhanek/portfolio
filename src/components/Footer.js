...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-gray-200 bg-light-dark py-12 dark:border-dark-border dark:bg-dark">
      <div className="container">
        <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
          ...
          <div className="flex space-x-4">
            <a 
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-gray-600 transition-all hover:bg-primary hover:text-white dark:bg-dark-light dark:text-gray-300 dark:hover:bg-primary-600"
              aria-label="GitHub"
            >
        ...
        <div className="flex flex-col items-center justify-between space-y-4 text-sm md:flex-row md:space-y-0">
          <div className="text-gray-600 dark:text-gray-400">
            &copy; {currentYear} Muhammad Asad Khan. All rights reserved.
          </div>
